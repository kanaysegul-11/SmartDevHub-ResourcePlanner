...
import { FeatherZap, FeatherLayout, FeatherTrendingUp, FeatherUsers, 
         FeatherFileText, FeatherLogOut, FeatherSearch } from "@subframe/core";
      ...
      <div className="flex w-64 flex-none flex-col items-start justify-between self-stretch border-r border-solid border-neutral-200 bg-white px-4 py-6 shadow-lg">
        <div className="flex w-full flex-col items-start gap-8">
          ...
          <div className="flex w-full flex-col items-start gap-1">
            <Button className="w-full justify-start rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 text-white" icon={<FeatherLayout />}>Dashboard</Button>
            <Button className="w-full justify-start rounded-lg" variant="neutral-tertiary" icon={<FeatherTrendingUp />}>Analytics</Button>
            ...
            <div className="col-span-12 lg:col-span-8 flex flex-col gap-4">
              ...
              {snippets.map(s => (
                <div key={s.id} className="bg-white p-6 rounded-xl border shadow-sm">
                  ...
                  <pre className="bg-slate-900 text-blue-300 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                    <code>{s.code}</code>
                  </pre>
                </div>
              ))}
